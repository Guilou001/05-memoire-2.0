...
- **Aucun des huit modèles ne bat l'équipondéré dans les échantillons publiés.** Les expositions au marché diffèrent, car les modèles vendent aussi à découvert. Le meilleur cas est le gradient
  boosting canadien : 4,1 % net par an (Sharpe 0,31, t de Newey-West 1,33, DSR 0,195 avec horizons harmonisés), contre 11,4 %
